...
#pragma config(Sensor, in2,    testPot,        sensorPotentiometer)
#pragma config(Sensor, dgtl1,  testDist,       sensorSONAR_mm)
...
#pragma config(Motor,  port10,          motorLauncherFive, tmotorVex393_HBridge, openLoop)
